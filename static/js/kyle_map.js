	...
	init: function(){
		...
		var legend = L.Control.extend({
		  ...
		  onAdd: function (map) {
		          ...
		          if($('#language').val()=='fr'){
			          this._div.innerHTML = '<ul><li><img src="https://api.mapbox.com/v4/marker/pin-m-garden+601919.png?access_token=pk.eyJ1IjoiZ2xhcm9jIiwiYSI6InJPQ0d5Nk0ifQ.LPiEFZJ_-jI33kmjqwvNqA" alt="" tabindex="0">Pommes</li><li><img src="https://api.mapbox.com/v4/marker/pin-m-garden+21223E.png?access_token=pk.eyJ1IjoiZ2xhcm9jIiwiYSI6InJPQ0d5Nk0ifQ.LPiEFZJ_-jI33kmjqwvNqA" alt="" tabindex="0">Bleuets</li><li><img src="https://api.mapbox.com/v4/marker/pin-m-garden+4F1257.png?access_token=pk.eyJ1IjoiZ2xhcm9jIiwiYSI6InJPQ0d5Nk0ifQ.LPiEFZJ_-jI33kmjqwvNqA" alt="" tabindex="0">Framboises</li></ul>'
			       }else{
